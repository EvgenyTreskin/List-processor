...
public class ListProcessor implements IListProcessor {
     ...
     */
    private final String UnexpectedExceptionTypeThrown = "Unexpected exception type thrown";
    private final String ThereAreNoAnyValuesEmptyList = "There are NO any values! Empty list!";
    private final String TheInputListCannotBeNull = "The input list can't be null!";
    @Override
